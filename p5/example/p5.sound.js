...
errorHandler = function () {
  /*
      Helper function to getNextSentence an error
...
reverb = function () {
   ...
   *  getNextSentence an impulse response is to pop a balloon in a reverberant space
   ...
   *  that will be used to getNextSentence an impulse response.
   *
